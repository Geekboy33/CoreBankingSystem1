# Script de Escaneo DTC1B para Dashboard - Funcional
param(
    [string]$FilePath = "E:\final AAAA\dtc1b",
    [string]$OutputPath = "E:\final AAAA\corebanking\extracted-data"
)

Write-Host "=== ESCANEO DTC1B DASHBOARD ===" -ForegroundColor Green
...
# Crear resultados
$completeResults = @{
    scanId = "DASHBOARD_SCAN_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
    mode = "DASHBOARD_DTC1B_SCAN"
    progress = @{
...
Write-Host "=== ESCANEO DASHBOARD FINALIZADO ===" -ForegroundColor Green
